...
# Lista para almacenar las subcadenas duplicadas con las modificaciones aplicadas
subcadenas_duplicadas_modificadas = []
...
for i, (subcadena_modificada, subcadena_original) in enumerate(zip(subcadenas_modificadas, subcadenas)):
    ...
    subcadenas_duplicadas_modificadas.append(cambios_subcadena)

# Imprimir las subcadenas duplicadas con las modificaciones aplicadas
print("Subcadenas duplicadas con las modificaciones aplicadas:")
for i, cambios_subcadena in enumerate(subcadenas_duplicadas_modificadas):
    print(f"Subcadena original: {subcadenas[i]}")
    for j, subcadena in enumerate(cambios_subcadena):
        print(f"Subcadena modificada {j + 1}: {subcadena}")
    print()